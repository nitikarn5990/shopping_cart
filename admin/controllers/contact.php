                ...
                <form id="validate" enctype="multipart/form-data" action="<?php echo ADDRESS_ADMIN_CONTROL?>contact<?php echo ($contact->GetPrimary() != '') ? '&id=' . $contact->GetPrimary() : ''; ?>" method="post" class="da-form">
                   ...
                   <div class="da-form-row">
                            ...
                            <div class="da-form-item large">
                                ...
                                <textarea name="meta_title" id="meta_title" class="span12"><?php echo ($contact->GetPrimary() != '') ? $contact->GetValue('meta_title') : ''; ?></textarea>
                        ...
                        <div class="da-form-row">
                            ...
                            <div class="da-form-item large">
                                ...
                                <textarea name="meta_keywords" id="meta_keywords" class="span12"><?php echo ($contact->GetPrimary() != '') ? $contact->GetValue('meta_keywords') : ''; ?></textarea>
                        ...
                        <div class="da-form-row">
                            ...
                            <div class="da-form-item large">
                                ...
                                <textarea name="meta_descriptions" id="meta_descriptions" class="span12"><?php echo ($contact->GetPrimary() != '') ? $contact->GetValue('meta_descriptions') : ''; ?></textarea>
